...
using DominioRico.Pagamentos.AntiCorruption;
using DominioRico.Pagamentos.Business;
using DominioRico.Pagamentos.Business.Events;
using DominioRico.Pagamentos.Data;
using DominioRico.Pagamentos.Data.Repository;
